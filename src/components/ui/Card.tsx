...
interface CardProps {
  ...
  ownedCard: PokemonCard | undefined; // Represents the owned card object or undefined if not owned
}

export function Card({ card, onToggleOwnership, ownedCard }: CardProps) {
